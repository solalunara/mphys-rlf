...
generated_analyzer = ImageAnalyzer( utils.paths.GENERATED_SUBDIR, export_images=[ 'gaus_model', 'gaus_resid' ] );
dataset_analyzer = ImageAnalyzer( utils.paths.DATASET_SUBDIR, export_images=[ 'gaus_model', 'gaus_resid' ] );
